...
from scanner.scanners_refactored_batch2 import (
    XSSScanner,
    SQLInjectionScanner,
    CSRFScanner,
    InformationDisclosureScanner,
...
class TestXSSScanner:
    ...
    def test_detect_dom_xss_pattern(self):
        ...
        # When
        scanner = XSSScanner(html_content=html)
        result = scanner.scan()
...
class TestSQLInjectionScanner:
    ...
    def test_detect_sql_error_messages(self):
        ...
        # When
        scanner = SQLInjectionScanner(html_content=html)
        result = scanner.scan()
...
class TestBatch2Integration:
    ...
    def test_all_scanners_base_scanner_compatible(self):
        ...
        scanners = [
            XSSScanner(html_content='<html></html>'),
            SQLInjectionScanner(html_content='<html></html>'),
